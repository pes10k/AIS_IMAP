...
of how the library is interacting with the IMAP mailbox and its contents.

Although classes are explicitly included using 'include_once', the class names
follow the PCR-0 standards.  If your setup has a PCR-0 autoloader, these includes
can be excluded.
...
The AIS_IMAP library requires the following code / libraries be installed
    ...
    - The PEAR Date class (http://pear.php.net/package/Date)
...
AISLabs a full-service technology firm that provides IT staffing, consulting, value-added equipment sales, and cloud services. Specializations include web design, application development, VoIP phone systems, low voltage wiring, and digital signage.
